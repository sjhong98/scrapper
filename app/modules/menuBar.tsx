...
export default function MenuBar() {
    ...
    return (
        <div className="w-screen sm:w-auto bg-white flex sm:justify-start justify-between right-0 sm:mr-12 sm:mt-12 fixed sm:top-0 top-[91vh] cursor-pointer sm:flex-col flex-row" style={{zIndex:9999}} >
            <DashboardIcon onClick={()=>router.push('/posts')} onMouseOver={()=>setMenuHomeOver(true)} onMouseLeave={()=>setMenuHomeOver(false)} className={menuHomeOver ? "scale-up" : "scale-down"} sx={{fontSize:50, color:'black', marginTop:'3vh'}} />
